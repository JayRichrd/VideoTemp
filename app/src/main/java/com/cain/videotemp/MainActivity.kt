...
import com.cain.videotemp.SimpleRenderActivity.Companion.TYPE_CUSTOM_OPEN_GL
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_custom_open_gl.setOnClickListener(this)
        // Android 6以上动态权限申请
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_custom_open_gl -> {
                val intent = Intent(this, SimpleRenderActivity::class.java)
                intent.putExtra(TYPE_RENDER, TYPE_CUSTOM_OPEN_GL)
                startActivity(intent)
            }
            else -> {
